...
ssp2_file = "data/Europe_Grid_SSP2_Population_Annual_2020_2080.csv"
...
output_static = "data/Europe_Grid_SSP2_Static_Age_Pop_2025_2080.csv"
output_median = "data/Europe_Grid_SSP2_Median_Fert_Age_Pop_2025_2080.csv"
output_high = "data/Europe_Grid_SSP2_High_Fert_Age_Pop_2025_2080.csv"
output_low = "data/Europe_Grid_SSP2_Low_Fert_Age_Pop_2025_2080.csv"
ssp2 = pd.read_csv(ssp2_file)
...
data = baseline[["grid_id", "Country", "population_2020"]].merge(
    ssp2, on="grid_id", how="inner"
)
years = range(2025, 2081)
for year in years:
    col_name = f"ssp2_{year}"
    if col_name in data.columns:
        data[f"growth_factor_{year}"] = data[col_name] / data["ssp2_2020"]
    if year % 10 == 0:
        pass
for year in years:
