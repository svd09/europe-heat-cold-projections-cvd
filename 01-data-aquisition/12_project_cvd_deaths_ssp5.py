...
ssp5_static_file = "data/Europe_Grid_SSP5_Static_Age_Pop_2025_2080.csv"
ssp5_median_file = "data/Europe_Grid_SSP5_Median_Fert_Age_Pop_2025_2080.csv"
ssp5_high_file = "data/Europe_Grid_SSP5_High_Fert_Age_Pop_2025_2080.csv"
ssp5_low_file = "data/Europe_Grid_SSP5_Low_Fert_Age_Pop_2025_2080.csv"
output_static = "data/SSP5_Static_CVD_Deaths_Grid_2025_2080.csv"
output_median = "data/SSP5_Median_Fert_CVD_Deaths_Grid_2025_2080.csv"
output_high = "data/SSP5_High_Fert_CVD_Deaths_Grid_2025_2080.csv"
output_low = "data/SSP5_Low_Fert_CVD_Deaths_Grid_2025_2080.csv"
output_static_country = "data/SSP5_Static_CVD_Deaths_Country_2025_2080.csv"
output_median_country = "data/SSP5_Median_Fert_CVD_Deaths_Country_2025_2080.csv"
output_high_country = "data/SSP5_High_Fert_CVD_Deaths_Country_2025_2080.csv"
output_low_country = "data/SSP5_Low_Fert_CVD_Deaths_Country_2025_2080.csv"
baseline = pd.read_csv(baseline_file)
ssp5_static = pd.read_csv(ssp5_static_file)
ssp5_median = pd.read_csv(ssp5_median_file)
ssp5_high = pd.read_csv(ssp5_high_file)
ssp5_low = pd.read_csv(ssp5_low_file)
age_groups = {
    "under_20": {
...
results_static = project_cvd_deaths(baseline, ssp5_static, "Static", is_static=True)
country_static = create_country_summary(results_static, "Static")
results_median = project_cvd_deaths(baseline, ssp5_median, "Median", is_static=False)
country_median = create_country_summary(results_median, "Median")
results_high = project_cvd_deaths(baseline, ssp5_high, "High", is_static=False)
country_high = create_country_summary(results_high, "High")
results_low = project_cvd_deaths(baseline, ssp5_low, "Low", is_static=False)
